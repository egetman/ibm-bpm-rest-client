package ru.groomsh.bpm.model.common;

import com.google.gson.annotations.SerializedName;

import static ru.groomsh.util.Constants.*;
...
public class RestRootEntity <T extends Describable> extends RestEntity {
    ...
    /**
     * @return true if the API call was unsuccessfull, and {@link ru.groomsh.bpm.model.common.RestRootEntity} contains exception information.
     */
     ...
     * @throws ru.groomsh.bpm.model.common.RestException if the API call was unsuccessfull, and {@link ru.groomsh.bpm.model.common.RestRootEntity}
