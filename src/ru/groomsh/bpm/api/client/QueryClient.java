...
import ru.groomsh.bpm.model.query.*;
...
public interface QueryClient {
	 ...
	 * @return list of queries for entity instance data (see {@link ru.groomsh.bpm.model.query.QueryList}});
	 */
	 ...
	 * 		 	(see {@link ru.groomsh.bpm.model.query.QueryAttribute}) which specifies the semantic use and implicit
	 ...
	 * 			For example, if you specified {@link ru.groomsh.bpm.model.query.QueryAttribute} content = TASK.PRIORITY, TASK.TKIID
	 ...
	 * @param query Query for task instance data (see {@link ru.groomsh.bpm.model.query.Query});
	 * @param selectedAttributes List of attributes (see {@link ru.groomsh.bpm.model.query.QueryAttribute}), which specifies the attributes that are retrieved by the query.
	 * 		 	If no selected attributes are specified, all of the attributes that are defined on the query are returned.
	 * @param interactionFilter Name of a predefined user interaction (see {@link ru.groomsh.bpm.model.query.InteractionFilter});
	 ...
	 * @param processAppName Name of the process application, used for additional filtering.
	 * @param sortAttributes List of sort criteria (see {@link ru.groomsh.bpm.model.query.SortAttribute}) applied to the list of returned process instance entities.
	 ...
	 * @return detailed information about entity instances (see {@link ru.groomsh.bpm.model.query.QueryResultSet});
	 * @throws IllegalArgumentException if specified {@link ru.groomsh.bpm.model.query.Query} is null
	 */
	 ...
	 * 			then this parameter is ignored and a filtered search is performed.
	 * 			Note: This parameter is used only when the request is being executed by an administrative user and no interactionFilter parameter is set, otherwise it is ignored.
	 * @return number of entities in a query matching specified criteria. (see {@link ru.groomsh.bpm.model.query.QueryResultSetCount})
	 * @throws  IllegalArgumentException if specified {@link ru.groomsh.bpm.model.query.Query} is null
	 */
	 ...
	 * @param processAppName Name of the process application, used for additional filtering. 
	 * 		  	This parameter is intended for future use and has currently no effect on the returned query metadata.
	 * @return all available attributes of specified query (see {@link ru.groomsh.bpm.model.query.QueryAttributes})
	 * @throws IllegalArgumentException if specified {@link ru.groomsh.bpm.model.query.Query} is null
	 */
