...
public interface QueryClient {
     ...
     * 	   	queries: {@link ru.bpmink.bpm.model.query.QueryList}
     */
    RestRootEntity<QueryList> listQueries(@Nullable String processAppName,
     ...
     *      restricted to those entities associated with the current user. A value of false means that an unfiltered
     *      search will be performed, whereas a value of true indicates that the search results will be filtered by
