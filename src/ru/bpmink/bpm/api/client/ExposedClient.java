...
public interface ExposedClient {
	 ...
	 * @return {@link ru.bpmink.bpm.model.other.exposed.ExposedItems}
	 */
	 ...
	 * @param itemName is a full name of item (see {@link ru.bpmink.bpm.model.other.exposed.Item#getName()})
